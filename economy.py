...
SUPPLY_CHAIN = {
    ...
    "ANTIMATTER": ["ADVANCED_CIRCUITRY", "LAB_INSTRUMENTS"],
    ...
    "EXOTIC_MATTER": ["ADVANCED_CIRCUITRY", "LAB_INSTRUMENTS"],
    "EXPLOSIVES": ["LIQUID_NITROGEN", "LIQUID_HYDROGEN"],
    "FABRICS": ["FERTILIZERS"],
    ...
    "SHIP_SALVAGE": ["SHIP_PLATING", "SHIP_PARTS"],
...
def get_all_predecessors(item_list):
    predecessors = []
    for i in item_list:
        predecessor_list = SUPPLY_CHAIN[i]
        for j in predecessor_list:
            if j not in predecessors:
                predecessors.append(j)
        for j in get_all_predecessors(predecessor_list):
            if j not in predecessors:
                predecessors.append(j)
    return predecessors


def get_immediate_predecessors(item_list):
    predecessors = []
    for i in item_list:
        predecessor_list = SUPPLY_CHAIN[i]
        for j in predecessor_list:
